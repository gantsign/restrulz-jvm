...
/**
 * Base class for validating int values.
 *
 * @constructor creates an instance of the int validator with the specified constraints.
 ...
 */
@Suppress("unused")
abstract class IntValidator protected constructor(private val minimumValue: Int,
     ...
     */
    fun requireValidValue(parameterName: String, value: Int): Int {
     ...
     */
    fun requireValidValueOrNull(parameterName: String, value: Int?): Int? {
        if (value === null) {
            return value
        }
     ...
     */
    fun validateValue(value: Int, validationHandler: ValidationHandler): Boolean {
        if (value < minimumValue) {
     ...
     */
    fun validateValueOrNull(value: Int?, validationHandler: ValidationHandler): Boolean {
        if (value === null) {
            return true
        }
