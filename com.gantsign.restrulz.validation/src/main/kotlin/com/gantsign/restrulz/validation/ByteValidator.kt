...
/**
 * Base class for validating byte values.
 *
 ...
 */
@Suppress("unused")
abstract class ByteValidator protected constructor(private val minimumValue: Byte,
                                                   private val maximumValue: Byte) {
     ...
     */
    fun requireValidValue(parameterName: String, value: Byte): Byte {
     ...
     */
    fun requireValidValueOrNull(parameterName: String, value: Byte?): Byte? {
        if (value === null) {
            return value
        }
     ...
     */
    fun validateValue(value: Byte, validationHandler: ValidationHandler): Boolean {
        if (value < minimumValue) {
     ...
     */
    fun validateValueOrNull(value: Byte?, validationHandler: ValidationHandler): Boolean {
        if (value === null) {
            return true
        }
