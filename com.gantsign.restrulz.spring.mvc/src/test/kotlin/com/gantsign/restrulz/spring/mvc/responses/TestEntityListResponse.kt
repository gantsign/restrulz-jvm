...
class TestEntityListResponse private constructor(
    ...
    companion object {
        fun partialContent(values: List<TestEntity>): TestEntityListResponse {
            val typedList: Any? = object : ArrayList<TestEntity>(values) {}

            val headers = HttpHeaders()
            headers.contentType = MediaType.APPLICATION_JSON

            return TestEntityListResponse(
